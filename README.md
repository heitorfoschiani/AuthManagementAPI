...
2. Then, go to the "AuthManagementAPI -> app -> database -> access_information.env", and update the "CREDENTIALS_FILE_PATH" variable with the path to the .env file you've saved on your computer.
