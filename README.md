...
3. Finally, create a database called "AuthenticationManagement" on your postgres sever or, if you want to connect with another database, you can change the variable "DBNAME" in "AuthManagementAPI -> app -> database -> access_information.env". It`s suggest to do not use an already existent database.
